...
public class CoinbaseProManualExample {
    ...
    public static void main(String[] args) {
        ...
        CoinbaseProStreamingExchange exchange = (CoinbaseProStreamingExchange) StreamingExchangeFactory.INSTANCE.createExchange(spec);
        ...
        if (StringUtils.isNotEmpty(apiKey)) {
            ...
            exchange.getStreamingMarketDataService().getRawWebSocketTransactions(CurrencyPair.LTC_EUR, false)
