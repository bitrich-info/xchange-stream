...
public class CoinmateStreamingMarketDataServiceTest {
    ...
    public void testGetTrades() throws Exception {
        ...
        Trade expected1 = new Trade(null, new BigDecimal("0.08233888"), CurrencyPair.BTC_CZK, new BigDecimal("855.29"), new Date(1484863030522L), "BUY11175383SELL11175341");
        Trade expected2 = new Trade(null, new BigDecimal("0.00200428"), CurrencyPair.BTC_CZK, new BigDecimal("855.13"), new Date(1484863028887L), "BUY11175383SELL11174771");
