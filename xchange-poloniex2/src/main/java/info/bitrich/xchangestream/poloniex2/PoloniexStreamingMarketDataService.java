...
public class PoloniexStreamingMarketDataService implements StreamingMarketDataService {
  ...
  public PoloniexStreamingMarketDataService(
      PoloniexStreamingService service, Map<CurrencyPair, Integer> currencyPairMap) {
  ...
  public Observable<Ticker> getTicker(CurrencyPair currencyPair, Object... args) {
    ...
    Observable<PoloniexWebSocketTickerTransaction> subscribedChannel =
        service
            .subscribeChannel("1002")
